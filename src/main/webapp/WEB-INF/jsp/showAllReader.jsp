				...
				<c:forEach items="${requestScope.pageMsg.lists}" var="admin">
					<tr>
						...
						<td><a class="layui-btn"
							...
							href="showReaderBorrowDetail?id=${admin.id }&adminName=${admin.adminName }">查看</a>
						...
						<td><a class="layui-btn"
							...
							href="deleteReader?id=${admin.id }" onclick="return confirm('确认删除${admin.adminName }吗？')">删除</a>
						</td>
						<%-- <td>${admin.identityId }</td> --%>
					</tr>
				</c:forEach>
